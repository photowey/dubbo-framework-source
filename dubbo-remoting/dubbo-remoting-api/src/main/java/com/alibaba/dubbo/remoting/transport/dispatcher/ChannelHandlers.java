...
public class ChannelHandlers {
    ...
    protected ChannelHandler wrapInternal(ChannelHandler handler, URL url) {
        // 对 ChannelHandler 进行包装,dispatcher 默认是 AllDispatcher
        Dispatcher dispatcher = ExtensionLoader.getExtensionLoader(Dispatcher.class).getAdaptiveExtension();
        ChannelHandler channelHandler = dispatcher.dispatch(handler, url);
        HeartbeatHandler heartbeatHandler = new HeartbeatHandler(channelHandler);
        // TODO 多层包装
